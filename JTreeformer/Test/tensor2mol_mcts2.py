...
#     folder="D:\\MolDataSet\\"
#     vocab_path = "vocab_moses.txt"
#     with open(folder+vocab_path, 'r') as file:
...
#
#     node_a = MolTreeNode(vocab.get_smiles(428))
#     node_a.wid = 428
#     node_a.idx = len(all_nodes)
#     node_a.fa=root
#     node_a.children = []
#     node_a.neighbors.append(root)
#     root.children.append(node_a)
#     root.neighbors.append(node_a)
#     all_nodes.append(node_a)
#     # root=None
#
#     node_x = MolTreeNode(vocab.get_smiles(140))
#     node_x.wid = 140
#     node_x.idx = len(all_nodes)
#     node_x.fa=root
#     node_x.children = []
#     node_x.neighbors.append(root)
#     root.children.append(node_x)
#     root.neighbors.append(node_x)
#     all_nodes.append(node_x)
#
#     node_y = MolTreeNode(vocab.get_smiles(140))
#     node_y.wid = 140
#     node_y.idx = len(all_nodes)
#     node_y.neighbors.append(node_x)
#     node_y.fa = node_x
...
#     all_nodes.append(node_y)
#
#     node_z = MolTreeNode(vocab.get_smiles(414))
#     node_z.wid = 414
#     node_z.idx = len(all_nodes)
#     node_z.neighbors.append(node_x)
#     node_z.fa = node_x
#     node_z.children = []
#     node_x.neighbors.append(node_z)
#     node_x.children.append(node_z)
#     all_nodes.append(node_z)
#
#     cur_mol=MolTree2Mol(root,all_nodes)
#     print(cur_mol)
#     # import matplotlib.pyplot as plt
#     # from rdkit.Chem import Draw
#     # img=Draw.MolToImage(Chem.MolFromSmiles(cur_mol))
#     # plt.imshow(img)
#     # plt.show()